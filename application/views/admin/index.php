                ...
                <form class="form-horizontal" name="modForm" method="post" enctype="multipart/form-data" action="/index.php/dataFunction/adminModfiy">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11 col-sm-9 col-xs-12">
                            <input type="text" class="form-control" name="admin_id" placeholder="아이디" value="<?= $info->ADMIN_ID ?>" readonly required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12">비밀번호</label>
                        <div class="col-md-11 col-sm-9 col-xs-12">
                            <input type="password" class="form-control" name="admin_pwd" placeholder="비밀번호" value="" required>
                        </div>
                    </div>
